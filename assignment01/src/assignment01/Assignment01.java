...
public class Assignment01 {
    ...
    static String intToBitsImage(int subject) {
        ...
        if (subject == Integer.MIN_VALUE) return("10000000000000000000000000000000"); // HARD CODED IF NUMBER IS 'Integer.MIN'
        if (subjectIsNegative) subject *= -1;
